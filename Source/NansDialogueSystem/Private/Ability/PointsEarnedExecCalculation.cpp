...
struct NPointsEarnedStatics
{
	...
	NPointsEarnedStatics()
	{
		...
		DEFINE_ATTRIBUTE_CAPTUREDEF(UDialogueAttributeSets, PointsEarned, Source, true);
	}
};
	...
	OUT FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	PointsEarned += FMath::Max<float>(
		Spec.GetSetByCallerMagnitude(UDialogueSystemSettings::Get()->PointMagnitudeTag, false, 1.0f),
		0.0f
	);
