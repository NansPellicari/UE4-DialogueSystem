...
struct NANSDIALOGUESYSTEM_API FNCurrentOrAll
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct NANSDIALOGUESYSTEM_API FNFullValue
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct NANSDIALOGUESYSTEM_API FNAllOrName
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct NANSDIALOGUESYSTEM_API FNDialogueHistorySearch
{
	GENERATED_BODY()
