// Copyright 2022-present Nans Pellicari (nans.pellicari@gmail.com).
// 
...
#include "GA_BaseDialogue.generated.h"
 ...
 */
UCLASS()
class NANSDIALOGUESYSTEM_API UGA_BaseDialogue : public UGameplayAbility
{
	GENERATED_BODY()
public:
	UGA_BaseDialogue();
