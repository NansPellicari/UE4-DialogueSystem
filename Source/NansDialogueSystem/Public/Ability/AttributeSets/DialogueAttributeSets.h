...
#include "DialogueAttributeSets.generated.h"
...
*/
UCLASS()
class NANSDIALOGUESYSTEM_API UDialogueAttributeSets : public UAttributeSet
{
	GENERATED_BODY()
public:
	UDialogueAttributeSets();
	...
	ATTRIBUTE_ACCESSORS(UDialogueAttributeSets, PointsEarned);
};
